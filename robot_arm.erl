...
%% @end
%%--------------------------------------------------------------------
handle_call(_Request,{computer,up,open})->
    Response = [],
    {ok,Response,{computer,down,open}};

handle_call(_Request,{computer,down,open})->
    Response = [],
    {ok,Response,{computer,down,holding}};

handle_call(_Request,{computer,down,holding})->
    Response = [],
    {ok,Response,{computer,up,holding}};

handle_call(_Request,{computer,up,holding})->
    Response = [],
    {ok,Response,{box,up,holding}};

handle_call(_Request,{box,up,holding})->
    Response = [],
    {ok,Response,{box,down,holding}};
